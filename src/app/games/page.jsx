  ...
  return (
    <div>
      ...
      <div className="text-lg lg:text-2xl min-h-screen bg-gradient-to-r from-white to-purple-300 text-black font-bold flex p-40 mt-[-130px]">
        <h2 className="w-full">
          Em Hell Clock, você assume o papel de Pajeú, um ex-escravo e guerreiro destemido, determinado a resgatar seu mentor, Antônio Conselheiro, das forças sobrenaturais que assolam a região. Este jogo oferece uma experiência única ao combinar elementos de ARPG com mecânicas de roguelite, proporcionando combates intensos e desafiadores. <br />Com uma narrativa profunda ambientada em uma versão sombria da Guerra de Canudos, os jogadores enfrentarão demônios e criaturas místicas enquanto exploram masmorras traiçoeiras. A dublagem em português e a riqueza de detalhes culturais tornam Hell Clock uma jornada imperdível para os fãs de ação e história.
        </h2>
        <img src="/images/frame-games.webp" alt="" className="w-full h-auto rounded self-end" />
      </div>

      <div className="flex flex-col items-center text-lg lg:text-6xl min-h-screen bg-white text-purple-700 font-bold p-40 mt-[-130px]">
        <h1 className="text-center mt-[-120px]">
          Explore também outros trabalhos incríveis!
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 rounded-lg max-auto max-w-6xl px-4 mx-auto mt-20 ">
          <a href="https://www.horizonchaseturbo.com/pt-br">
          <img src="/images/Horizon Chase Turbo.webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto " />
          </a>
          <a href="https://blog.studiominiboss.com/games/outtheresomewhere.html">
          <img src="/images/download (12).webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto" />
          </a>
          <a href="https://www.bombservice.com">
          <img src="/images/momodora.webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto" />
          </a>
          <a href="https://alendadoheroi.com.br">
          <img src="/images/a-lenda-do-héroi.webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto" />
          </a>
          <a href="https://www.bombservice.com">
          <img src="/images/minoria.webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto" />
          </a>
          <a href="https://www.coffeeaddictstudio.com">
          <img src="/images/hazel.webp" alt="" className="w-full max-w-[500px] h-auto p-4 mx-auto" />
          </a>
        </div>
      </div>
    </div>
