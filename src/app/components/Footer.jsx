            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-1">
                    <ul className="space-y-1 font-semibold">
                        ...
                        <li>
                            <Link href="/posts" className="hover:text-white transition duration-300">
                                Posts
                            </Link>
                        </li>
                        <li>
                            <Link href="/newsletters" className="hover:text-white transition duration-300">
                                Newsletters
                            </Link>
                        </li>
                    </ul>
                ...
                <div className="col-span-1 md:col-span-1">
                    <ul className="space-y-1 font-semibold">
                        <li>
                            <Link href="/fale-conosco" className="text-green-500 underline">
                                Fale conosco
                            </Link>
                        </li>
                        <li>
                            <Link href="/anuncie" className="hover:text-white transition duration-300">
                                Anuncie na Volpe
                            </Link>
                        </li>
                    </ul>
                ...
                <div className="col-span-1 md:col-span-1">
                    <ul className="space-y-1 font-semibold">
                        <li>
                            <Link href="/termos-e-politicas" className="text-green-500 underline">
                                Termos e políticas
                            </Link>
                        </li>
                        <li>
                            <Link href="/politica-de-privacidade" className="hover:text-white transition duration-300">
                                Política de privacidade
                            </Link>
                        </li>
                        <li>
                            <Link href="/termos-de-uso" className="hover:text-white transition duration-300">
                                Termos de uso
                            </Link>
                        </li>
                    </ul>
